...
desc("n", "<leader>fM1", "Man Pages 1")
desc("n", "<leader>fM2", "Man Pages 2")
desc("n", "<leader>fM3", "Man Pages 3")
desc("n", "<leader>fM4", "Man Pages 4")
desc("n", "<leader>fM5", "Man Pages 5")
desc("n", "<leader>fM6", "Man Pages 6")
desc("n", "<leader>fM7", "Man Pages 7")
desc("n", "<leader>fM8", "Man Pages 8")
desc("n", "<leader>fM9", "Man Pages 9")
desc("n", "<leader>fMA", "Man Pages All")
